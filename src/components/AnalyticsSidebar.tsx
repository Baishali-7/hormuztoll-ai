...
export default function AnalyticsSidebar({
  ...
  return (
    <aside className="w-80 flex-shrink-0 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800 flex flex-col h-full overflow-hidden">
      {/* Header */}
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-xs pl-8 pr-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-600 placeholder:text-gray-500 dark:placeholder:text-gray-400"
          />
        </div>
        ...
        {filteredShips.length === 0 ? (
          ...
          filteredShips.map((ship) => (
            <button
              ...
              className={`w-full text-left px-4 py-3 border-b border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors flex items-center gap-3 ${
